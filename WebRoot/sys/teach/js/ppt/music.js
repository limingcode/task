...
(function($,window){
    ...
    DW.music = function(options) {
        ...
        musicValue._init = function(){
            ...
            _this.audio = $('<audio id="audioIndex'+audioIndex+'" class="audioIndex'+audioIndex+'" src=""></audio>').appendTo($('body'));
        ...
        musicValue._playPause = function(){
            var $thisAudio = document.getElementById(''+$(_this.audio[0]).attr('id')+'');
            console.log(this);
        ...
        musicValue._insertData = function(data,index){
            var music_imgUrl ='../sys/teach/images/ppt/theme/007.jpg';
            var music_name = data[index].name || '爱乐之城 纯音乐';
            var music_url = opt.source;
