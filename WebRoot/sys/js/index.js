...
*/
$(".iframe").attr("src",sessionStorage.getItem("iframeSrc") != null?sessionStorage.getItem("iframeSrc"):$(".nav1 ul li:first a").attr("href"));
$(".left div").eq(sessionStorage.getItem("liParentActive")).find("li").eq(sessionStorage.getItem("liActive")).addClass('active');
// 导航栏点击跳转
$(".nav ul").on('click', 'li', function(event) {
    ...
    if ($(this).find("a").attr("href")) {
        ...
        $(".right iframe").attr("src","iframeTest.html");
    }
    return false;
});
