/*
* @Author: Hlin
* @Date:   2018-03-07 10:37:31
* @Last Modified by:   Hlin
* @Last Modified time: 2018-03-09 11:03:38
*/
// 上传图片
window.addEventListener('DOMContentLoaded', function () {
    ...
    $('.crop_btn').on('click', function(event) {
        ...
        formData.append('uploadFile', convertBase64UrlToBlob(blodData));
        formData.append('studentId', studentId);

        var layerIndex  = layer.load(2,{ //进度显示
...
//            url: "http://localhost:9080/task/appUser/saveImgByTask.jhtml",  
            ...
            success : function(data) {  
                 $(".student_list li[studentid='"+studentId+"'] .avatar").attr('src', 'http://teaching.skyedu99.com/AppTask' + data.imageSrc)
...
//-----------------------------------------------------------------------------------------------------------------
//author 黄德彬
$('.filter_item').on('click', 'input', function(){
